MIPS: // files needed for simulation:
...
//logic aluswap  Part C chnage 
  controller c(instr[31:26], instr[5:0], zero,
               memtoreg, memwrite, pcsrc,
               alusrc, regdst, regwrite, jump, //aluswap
               alucontrol);
...
module controller(input  logic [5:0] op, funct,
                  ...
                  output logic       jump, //aluswap
                  output logic [2:0] alucontrol);
  // PART A_________________________________________
  //logic [1:0] aluop;
  //logic       branch;
...
//PART A_______________________________________
  //logic [8:0] controls;
  ...
  //always_comb
    ...
    //endcase
//PART B_______________________________________________________
  logic [9:0] controls;
  ...
  always_comb
    case(op)
      ...
      b'b001010: controls = 10'b1010000011; //SLTI
...
module aludec(input  logic [5:0] funct,
  ...
  always_comb
    case(aluop)
      ...
      2'b11: alucontrol = 3'b111 // PART B ___________________________
      default:
        case(funct)                // RTYPE
...
module datapath(input  logic        clk, reset,
  ...
  alu         alu1(.a(srca), .b(srcb), .f(alucontrol), .y(aluout), .zero(zero));
